...
const selectLogopedaByClientes = (idCliente) => {
  return db.query(
    `SELECT u.nombre, l.logopeda_id , u.apellidos, u.email, u.localidad, d.precio, d.experiencia, l.puntuacion, d.infancia_o_adulto,d.descripcion, u.imagen, u.rol, u.status as estado_u, l.fecha_inicio, l.status
